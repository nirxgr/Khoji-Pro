...
import { getProfile, getLoggedinUserData, searchUsers, getAllUsers } from '../controllers/userController.js';
...
userRouter.patch('/updateProfilePic',userAuth,multerErrorHandler, uploadProfilePic)
userRouter.delete('/deleteProfilePic',userAuth, deleteProfilePic)
userRouter.patch('/updateCoverPic',userAuth,multerErrorHandler, uploadCoverPic)
